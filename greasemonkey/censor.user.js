// ==UserScript==
// @name           Censor
// @namespace      http://github.com/ajakubek/censor
// @include        *
// ==/UserScript==
...
//	var INFO_LINK_CUSTOM_STYLESHEET = 'censor_js_info_link_stylesheet';
	...
	function addInfoLayer()
	{
		...
		// setting onclick attribute does not work due to Greasemonkey's
		// XPCNativeWrapper protection
		infoLink.addEventListener('click', uncensorWindow, true);
